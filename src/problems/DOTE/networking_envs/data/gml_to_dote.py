...
# Dynamically determine src_dir relative to this file
_script_dir = os.path.dirname(os.path.abspath(__file__))
src_dir = os.path.join(_script_dir, "zoo_topologies")
network_name = "Abilene"
dest_dir = network_name

#additional configuration variables
default_capacity = "200000000000.0"
demands_factor = 10.0
n_train_matrices = 3
n_test_martices = 1
...
with open(input_file_name) as f:
    while True:
        ...
        if line.startswith("node ["): #read node info
            ...
            edges[(edge_src, edge_dst)] = default_capacity
            continue
