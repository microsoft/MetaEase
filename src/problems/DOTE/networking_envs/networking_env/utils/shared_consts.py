...
class FolderPathCosts:
    # Dynamically determine the base path relative to this file
    import os
    _current_file = os.path.abspath(__file__)
    _networking_envs_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(_current_file))))
    BASE_PATH_LOCAL = _networking_envs_dir
